...
import { OUTPUT_DEFAULT_VALUE, REPO_DEFAULT_VALUE, SOURCE_DEFAULT_VALUE, TO_DEFAULT_VALUE, } from '../../../constant/cliConstants.js';
import sgd from '../../../main.js';
import { log } from '../../../utils/LoggingDecorator.js';
import { Logger } from '../../../utils/LoggingService.js';
import { MessageService } from '../../../utils/MessageService.js';
const messages = new MessageService();
export default class SourceDeltaGenerate extends SfCommand {
    ...
    async run() {
        ...
        this.spinner.start(messages.getMessage('info.CommandIsRunning'), undefined, { stdout: true });
        const output = {
        ...
        try {
            ...
            if (err instanceof Error) {
                finalMessage = `${messages.getMessage('info.CommandFailure')}: ${err.message}`;
...
__decorate([
    log
], SourceDeltaGenerate.prototype, "run", null);
