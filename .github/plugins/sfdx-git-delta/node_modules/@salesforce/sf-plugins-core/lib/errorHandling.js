 ...
 * - default to 1
 */
export const computeErrorCode = (e) => {
...
export const errorIsGack = (error) => {
    /** see test for samples  */
    const gackRegex = /\d{9,}-\d{3,} \(-?\d{7,}\)/;
    return (gackRegex.test(error.message) ||
...
export const errorIsTypeError = (error) => error instanceof TypeError ||
...
const isOclifError = (e) => 'oclif' in e ? true : false;
