...
import { ensureString, isAnyJson } from '@salesforce/ts-types';
...
const isJsforceApiError = (item) => typeof item === 'object' && item !== null && !Array.isArray(item) && ('errorCode' in item || 'message' in item);
const formatMultipleErrorMessages = (error) => {
...
const getErrorData = (error) => {
    if (!(error instanceof Error || error instanceof SfError))
        return undefined;
