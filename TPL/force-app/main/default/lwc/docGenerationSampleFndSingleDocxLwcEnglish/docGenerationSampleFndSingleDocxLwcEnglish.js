...
import { OMNIDEF } from './docGenerationSampleFndSingleDocxLwcEnglish_def.js';
import tmpl from './docGenerationSampleFndSingleDocxLwcEnglish.html';
import tmpl_nds from './docGenerationSampleFndSingleDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleFndSingleDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
