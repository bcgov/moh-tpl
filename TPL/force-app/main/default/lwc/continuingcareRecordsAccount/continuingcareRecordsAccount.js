...
import getHealthcareCostsCCForAccount from '@salesforce/apex/HCCostAccountController.getHealthcareCostsCCForAccount';
...
export default class ContinuingcareRecordsAccount extends LightningElement {
    @api recordId;
    column = COLUMNS;
    isFirstPage = true;
    isLastPage = false;
