...
import { OMNIDEF } from './docGenerationSampleFndSingleDocxServersideLwcEnglish_def.js';
import tmpl from './docGenerationSampleFndSingleDocxServersideLwcEnglish.html';
import tmpl_nds from './docGenerationSampleFndSingleDocxServersideLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleFndSingleDocxServersideLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
